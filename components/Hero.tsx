          ...
          >
            ...
            >
              {technologies.map((tech, index) => (
                ...
                >
                  <Badge
                    className="bg-background/30 backdrop-blur-sm border border-primary/20 hover:border-primary/50 text-foreground px-4 py-1.5 text-sm transition-all duration-300"
                  >
                    {tech}
                  </Badge>
                </motion.div>
